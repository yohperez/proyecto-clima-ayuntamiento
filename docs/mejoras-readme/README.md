...
> Proyecto de bootcamp · SomosF5 / AI4Inclusion · 2026
...
Aplicación Python para el **Ayuntamiento** que permite:
...
|---|-------|-------------|-----------------|
| IP-01 | Crear dataset `clima_dataset.csv` con datos de prueba  | equipo | `clima_dataset.csv` |
...
Desarrollado en el marco del bootcamp **SomosF5 / AI4Inclusion** — Madrid, 2026.  
Cliente simulado: Ayuntamiento · Departamento de Gestión de Riesgos Climáticos.
